...
public class Swiggy {
    public static void main(String[] args) {
        ...
        // Ensure the Next button is interactable before clicking
        ...
        // Add wait to ensure the page transition is complete before proceeding
        ...
        // Ensure the Pizza button is visible and clickable
        ...
        try {
            Thread.sleep(5000); // Extra wait to allow page to load properly
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
